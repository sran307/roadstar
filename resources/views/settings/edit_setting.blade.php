...
@section("title", "generalsettings")
@section("content")
<div class="container">
    @foreach($settings as $setting)
    <form action="{{route('general_settings.update', [$setting->id])}}" method="post" enctype="multipart/form-data">
    @csrf
    @method("put")
       <legend class="col-form-label">General Settings</legend>
        <div class="row form-group">
            <label for="name" class="col-md-2 col-form-label">Site Name <span class="star">*</span></label>
            <div class="col-md-8">
                <input type="text" name="site_name" placeholder="Enter your site name" class="form-control" value="{{$setting->site_name}}">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="meta_title" placeholder="Enter your meta title" class="form-control" value="{{$setting->meta_title}}">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="meta_keyword" placeholder="Enter your meta keyword" class="form-control" value="{{$setting->meta_keyword}}">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="meta_description" placeholder="Enter your meta description" class="form-control" value="{{$setting->meta_description}}">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="play_store_url" placeholder="Enter your play store url" class="form-control" value="{{$setting->play_store_url}}">
                <span class="star d-block">Note- Must use the link that contains HTTP or HTTPS </span>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="app_store_url" placeholder="Enter your app store url" class="form-control" value="{{$setting->app_store_url}}">
                <span class="star d-block">Note- Must use the link that contains HTTP or HTTPS </span>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="email" placeholder="Enter your email id" class="form-control" value="{{$setting->email}}">
                @if($errors->has("email"))
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="phone_number" placeholder="Enter your phone number" class="form-control" value="{{$setting->phone}}">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="address" placeholder="Enter your address" class="form-control" value="{{$setting->address}}">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="website_url" placeholder="Enter your website url" class="form-control" value="{{$setting->website_url}}">
                <span class="star d-block">Note- Must use the link that contains HTTP or HTTPS </span>
        ...
        <div class="row form-group">
            <label for="website_logo" class="col-md-2 col-form-label">Website Logo </label>
            <div class="col-md-1 sr_admin_image">
                <img src="{{asset('images/logos/'.$setting->website_logo)}}" alt="web image">
            </div>
            <div class="col-md-7">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="facebook_url" placeholder="Enter your facebook url" class="form-control" value="{{$setting->facebook_url}}">
                <span class="star d-block">Note- Must use the link that contains HTTP or HTTPS </span>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="twitter_url" placeholder="Enter your twitter url" class="form-control" value="{{$setting->twitter_url}}">
                <span class="star d-block">Note- Must use the link that contains HTTP or HTTPS </span>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="linkedin_url" placeholder="Enter your linked url" class="form-control" value="{{$setting->linkedin_url}}">
                <span class="star d-block">Note- Must use the link that contains HTTP or HTTPS </span>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="insta_url" placeholder="Enter your instagram url" class="form-control" value="{{$setting->instagram_url}}">
                <span class="star d-block">Note- Must use the link that contains HTTP or HTTPS </span>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="youtube_url" placeholder="Enter your youtube url" class="form-control" value="{{$setting->youtube_url}}">
                <span class="star d-block">Note- Must use the link that contains HTTP or HTTPS </span>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-1 sr_admin_image">
                <img src="{{asset('images/logos/'.$setting->favicon)}}" alt=" image">
            </div>
            <div class="col-md-6">
