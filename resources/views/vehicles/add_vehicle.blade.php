...
@section("content")
<div class="container">
<form action="{{route('vehicle_managements.store')}}" method="post" enctype="multipart/form-data">
    @csrf
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="vehicle_type" class="form-control" placeholder="Enter vehicle type" value="{{old('vehicle_type')}}">           
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <textarea type="text" name="description" placeholder="Description" class="form-control"> {{old('descripotion')}}</textarea>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="fare" placeholder="Enter the base fare" class="form-control" value="{{old('fare')}}">
                @if($errors->has("fare"))
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="price_per_km" placeholder="Enter the price per km" class="form-control" value="{{old('price_per_km')}}">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="vehicle_level" placeholder="Enter the vehicle level" class="form-control" value="{{old('vehicle_level')}}">
