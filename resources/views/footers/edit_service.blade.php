...
<div class="container">
    ...
    <form action="{{route('footer_services.update', [$service->id])}}" method="post" enctype="multipart/form-data">
    @csrf
    @method("put")
        <legend class="col-form-label">Edit Footer Service</legend>
        <div class="row form-group">
            <label for="name" class="col-md-2 col-form-label">Url Name <span class="star">*</span></label>
            <div class="col-md-8"> 
                <input type="text" name="name" placeholder="Enter the url name" class="form-control" value="{{$service->name}}"> 
                @if($errors->has("name"))
        ...
        <div class="row form-group">
            ...
            <div class="col-md-1 sr_admin_image">
                <img src="{{asset('images/icons/'.$service->icon)}}" alt="images">
            </div>
            <div class="col-md-7"> 
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8"> 
                <input type="text" name="url" placeholder="Enter the url" class="form-control" value="{{$service->link}}"> 
                @if($errors->has("url"))
