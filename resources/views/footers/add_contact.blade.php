...
@section("title", "add_contact")
@section("content")
<div class="container">
<form action="{{route('footer_contacts.store')}}" method="post" enctype="multipart/form-data">
    @csrf
        <legend class="col-form-label">Add Footer Links</legend>
